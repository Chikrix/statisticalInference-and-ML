...
offer_glm <- h2o.glm(x=predictorsIndices, y = outcomeIndex, training_frame = train_frame, 
                     validation_frame = test_frame, max_iterations = 100, solver = "L_BFGS", 
...
boxplot(log((as.vector(train_frame_call$length)))) 
hist(log((as.vector(train_frame_call$length))))
mean(as.vector(train_frame_call$length))
